...
public class DeblockFlightControllerIntegrationTest {
        ...
        public void testGetFlights() throws Exception {
                ...
                SearchResponseParam responseParam = new SearchResponseParam("CrazyAir", Suppliers.crazyAir, 100.00,
                                "LHR",
                ...
                SearchRequestParam request = new SearchRequestParam("LHR", "AMS", LocalDate.now(),
        ...
        public void testGetFlightsForInvalidDepartureDate() throws Exception {
                ...
                SearchRequestParam request = new SearchRequestParam("LHR", "AMS", LocalDate.now().minusDays(1),
                                LocalDate.now().plusDays(2),
                                2);
        ...
        public void testGetFlightsForInvalidOrigin() throws Exception {
                ...
                SearchRequestParam request = new SearchRequestParam("LH", "AMS", LocalDate.now(),
                                LocalDate.now().plusDays(2),
                                2);
